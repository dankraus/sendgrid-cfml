    ...
    function run( testResults, testBox ){
        ...
        describe("initlizations", function(){
            ...
            it('allows attributes to be set on init ', function() {
                var email = new SendGridCFML.models.Email(options);
        ...
        describe("toWebFormat()", function(){
            ...
            it( "should not have a to address if there is no to or no smtpapi", function(){
                var email = new SendGridCFML.models.Email({ from: 'test@test.com',
                                                            subject: 'testing',
                                                            text: 'testing' });
            ...
            it( "should error when missing, to, from, subject, and text or html", function(){
                expect(function(){
                    var email = new SendGridCFML.models.Email({to: 'joel.ripken@seinfeld.com'});
                    email.toWebFormat();
                }).toThrow('exception', 'Email must include to, from, subject, and text or html');
                expect(function(){
                    var email = new SendGridCFML.models.Email({from: 'joel.ripken@seinfeld.com'});
                    email.toWebFormat();
                }).toThrow('exception', 'Email must include to, from, subject, and text or html');
                expect(function(){
                    var email = new SendGridCFML.models.Email({subject: 'The jerk store called...'});
                    email.toWebFormat();
                }).toThrow('exception', 'Email must include to, from, subject, and text or html');
                expect(function(){
                    var email = new SendGridCFML.models.Email({text: "..and they're running out of you!"});
                    email.toWebFormat();
                }).toThrow('exception', 'Email must include to, from, subject, and text or html');
                expect(function(){
                    var email = new SendGridCFML.models.Email({to: "reilly@nyyankees.com",
